...
interface AssetSimilarityStrategyInterface
{
     ...
     * @return boolean
     */
    public function hasSimilarAssets(AssetInterface $asset);
     ...
     * @return integer
     */
    public function getSimilarAssetCount(AssetInterface $asset);
     ...
     */
    public function getSimilarAssets(AssetInterface $asset);
}
